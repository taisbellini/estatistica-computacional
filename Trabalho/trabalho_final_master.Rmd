...
funcao_p = function(encoded_text, reference_bigrams, reference_freq){
  ...
  return (p_result*0.25) # multiplicador da implementacao dos autores do artigo
}
...
```{r}
mcmc = function(encoded, key0, reference_bigrams, reference_freq, proposal=2, nr=10000, p = 1.5) {
  ...
  for (i in 1:nr){
    ...
    f_old = funcao_p(decoded_old, reference_bigrams, reference_freq)
...
# Rodando o MCMC
result = mcmc(encoded, key0, REFERENCE_FREQUENCY$bigrams, REFERENCE_FREQUENCY$Freq, proposal = proposal, nr = nr ,p=p)
result
