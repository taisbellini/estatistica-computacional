...
```{r}
mcmc = function(encoded, key0, reference_bigrams, reference_freq, nr=10000, p = 10) {
...
result = mcmc(encoded, key0, reference$bigrams, reference$Freq, nr = 50000, p=50)
result
...
$key_max
 [1] "D" "B" "H" "U" "P" "A" "G" "W" "X" "J" " " "K" "M" "F" "O" "L" "Q" "R" "T" "V" "I" "Y" "S" "E" "C" "Z" "N"
...
dec = decode_subs(result$key_max, encoded)
dec
  T   H   I   S       I   S       A       T   E   X   T       T   O       E   N   C   R   Y   P   T 
"E" "A" "T" "O" " " "T" "O" " " "D" " " "E" "S" "H" "E" " " "E" "N" " " "S" "I" "C" "L" "F" "R" "E" 
accuracy_text = accuracy(text, dec)
accuracy_text
[1] 0.24
acceptance_rate = result$accept/nr
...
$key_max
 [1] "F" "B" "L" "K" "H" "E" "M" "U" "V" "J" "G" "Y" "X" "O" "T" "C" "Q" "A" "W" "N" " " "I" "D" "Z" "R" "S" "P"
...
> dec
  T   H   I   S       I   S       A       T   E   X   T       T   O       E   N   C   R   Y   P   T 
" " "W" "I" "N" "T" "I" "N" "T" "H" "T" " " "O" "S" " " "T" " " "A" "T" "O" "M" "E" "D" "R" "Y" " " 
> accuracy_text = accuracy(text, dec)
> accuracy_text
[1] 0.08
> acceptance_rate = result$accept/nr
...
Testar nova funcao_p 
Testar funcao_p com PIPOWER = 0.25
